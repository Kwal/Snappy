...
namespace Snappy
{
    internal class BufferManager
    {
        ...
        private static ThreadLocal<WeakReference> _bufferReference = new ThreadLocal<WeakReference>();
        ...
        public static BufferManager GetInstance()
        {
            ...
            if (_bufferReference.Value == null)
            {
                manager = null;
            }
            else
            {
                manager = _bufferReference.Value.Target as BufferManager;
            }

            if (manager == null)
            {
                manager = new BufferManager();
                _bufferReference.Value = new WeakReference(manager, false);
            }
